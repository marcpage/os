...
namespace trace {
	...
	/*
		...
		0   Backtrace_clang++_trace             0x000000010c8783f0 _ZN5trace5stackERNSt3__16vectorINS0_12basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEENS5_IS7_EEEEi + 112
	*/
	...
	inline std::string demangleLine(const std::string &line) {
		...
		++start;
		return line.substr(0, start) + demangleName(line.substr(start, end - start)) + line.substr(end);
	}
	/*
		0   Backtrace_clang++_trace             0x000000010c8783f0 _ZN5trace5stackERNSt3__16vectorINS0_12basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEENS5_IS7_EEEEi + 112
	*/
	...
	inline StringList &stack(StringList &list, int maxDepth=4096) {
		const int	skipStackFrames = 4; // trace::stack() call, std::string, and Exception x 2
