...
namespace io {
	...
	/**
		@todo Test!
	*/
	inline FileDescriptor::FileDescriptor(const std::string &path, int oflag, mode_t mode)
			:_descriptor(ErrnoOnNegative(::open(path.c_str(), oflag, mode))), _owned(true) {}
	/**
		@todo Test!
	*/
	inline FileDescriptor::FileDescriptor(const int descriptor):_descriptor(descriptor), _owned(false) {}
	/**
		@todo Test!
	*/
